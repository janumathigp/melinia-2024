...
function Footer() {
  ...
  return (
    ...
    <Container fluid className="footer" style={{ zIndex: '10', position: 'relative', height: "150px", display: "flex", flexDirection: "column", justifyContent: "space-around"}}>
      <div className="dummy" style={{display:"flex", flexDirection:"row", justifyContent:"space-around"}}>
      ...
      <div className="dum" style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div className="developed-with-love" style={{ fontSize: "15px", color: "white", textDecoration:"underline" }} onClick={handleClick}>
          Developed with love
        </div>
    </Container>
  );
